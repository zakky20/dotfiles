...
keys = [
    ...
    Key([mod], "d", lazy.spawn("dmenu_run"), desc="App launcher"),
...
def init_screens():
    return [Screen(top=bar.Bar(widgets=init_widgets_screen1(), margin=[0, 0, 0, 0], size=27)),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(), margin=[0, 0, 0, 0], size=27)),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(), margin=[0, 0, 0, 0], size=27))]
